...
function remove(p_tokens in token_table) return nclob;
...
- p_tokens (IN):  The tokens for a statement, probably generated by tokenizer.
...
function remove(p_tokens in token_table) return nclob is
