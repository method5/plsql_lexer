...
2. Add statement (view) expander program?
3. Fix/refactor statement splitter bug, more unit tests.
4. Thoroughly test by using code in other project I'm trying to open source?
